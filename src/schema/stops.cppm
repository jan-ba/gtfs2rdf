...
export Schema buildStopsSchema(runtime::RuntimeContainer& rt) {
    ...
    TRANSFORM2ONE(loc2Enum, ARGS, OUT_VAL, STORAGE)
        ...
        switch (c) {
            case '0': OUT_VAL = "stop";           break;
            case '1': OUT_VAL = "station";        break;
            case '2': OUT_VAL = "entrance_exit";  break;
            case '3': OUT_VAL = "generic_node";   break;
            case '4': OUT_VAL = "boarding_area";  break;
